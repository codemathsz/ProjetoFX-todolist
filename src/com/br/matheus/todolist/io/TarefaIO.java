...
public class TarefaIO {
	// static POR CAUSA DOS METODOS QUE SÃO static E FINAL POIS NÃO VARIA, É
	// CONSTANTE
	...
	public static void createFile() {
		try {
			...
			e.printStackTrace();// IMPRIMIR O ERRO NO CONSOLE, E COM O JOptionPane NÃO SERIA O CORRETO POIS ESSA
								// CLASSE NÃO DEVE TER CONTATO COM A JANELA
		}
	}

	// MÉTODO QUE INSERE UMA TAREFA         throws MANDA PARA "CIMA" O TIPO DE EXCEPTION
	public static void insert(Tarefa tarefa) throws FileNotFoundException, IOException {
		...
		Scanner leitor = new Scanner(arqIDs);// USAMOS THOROWS(MANDAR O ERRO PARA QUEM CHAMOU, REPASSANDO UMA EXCEPTION)
												// POE QUE ESTAMOS MEXENDO COM ARQUIVO E O JAVA NÃO DAIXA EXECUTAR SEM
	...
	public static List<Tarefa> readTarefas() throws IOException {// List <"TEM QUE SER DE UMA CLASSE, E PARA USAR OS
		...
		while ((linha = buff.readLine()) != null) {
			...
			t.setId(Long.parseLong(vetor[0]));// Long.parseLong, CONVERTENDO O VETOR STRING PARA LONG, POR QUE O Id É DO
												// TIPO long
		...
		// FileReader ESTÁ CONECTANDO o BufferedReader AO ARQUIVO, o Buff é MELHOR QUE o
		// FileReader
	}
